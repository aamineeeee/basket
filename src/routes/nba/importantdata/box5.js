...
import './nba_stats.css';  // Utiliser un CSS spécifique pour Box5
import SortableTable from '../../../components/SortableTable';
import data from './box5data'; // Importation des données spécifiques à Box5
...
const Box5 = () => {
  ...
  useEffect(() => {
    if (data && data.players) { // Accéder à "players" dans data
