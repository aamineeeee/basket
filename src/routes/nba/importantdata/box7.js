...
import './nba_standings.css';  // Assurez-vous d'utiliser le bon CSS pour Box7
import SortableTable from '../../../components/SortableTable';

// Importation des données des clubs depuis 'box7data.js'
import data from './box7data'; // Importation des données de clubs pour Box7
