 ...
 */
const getImage = (id) => {
    return `${process.env.PUBLIC_URL}/assets/images/nba_logos/${id}.svg`;
}
...
const BoxScore = (data) => {
    ...
    return (
        <div>
            <div className="card">
                <h2><img src={getImage(home.team.id)} height='50' alt={home.team.displayName}></img> {home.team.displayName}</h2>
                <div className="table-container">
                    {generateTable('home', homePlayers)}
                </div>
            </div>
            <div className="card">
                <h2><img src={getImage(away.team.id)} height='50' alt={away.team.displayName}></img> {away.team.displayName}</h2>
                <div className="table-container">
